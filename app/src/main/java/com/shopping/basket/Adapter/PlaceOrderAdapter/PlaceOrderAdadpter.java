package com.shopping.basket.Adapter.PlaceOrderAdapter;
...
public class PlaceOrderAdadpter extends RecyclerView.Adapter<PlaceOrderAdadpter.MyViewHolder> {
    ...
    public PlaceOrderAdadpter(FragmentActivity mContext, List<CartList> listPhone) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.place_order_item, parent, false);
